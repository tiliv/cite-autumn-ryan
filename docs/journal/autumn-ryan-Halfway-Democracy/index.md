...
The digital era has shown us that data _is_ valuable, and that our cities can be made better with it. Rather than using national and trans-national brands to gain that observability (all of those brands being vulnerable to the Unitary Executive with data in its enriched states) we must instead provide the narrow and appropriately kept public record of public comments and questions. City representatives can do with this as it wishes, but accountability is at last placed in the hands of the civil servants, and they can be elected or recalled as necessary to manage it.
