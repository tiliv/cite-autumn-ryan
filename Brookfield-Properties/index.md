...
- At the return visit, the human agent of Brookfield Properties listened to the questions recorded above. I skipped only the one about where they'll work after they lose their jobs.
...
{% include cite.html
  credit="November 8: Email with footer signed by 'Service Account'"
...
{% include cite.html
  credit="November 9: Me, to the human property manager directly"
  headline="Re: EliseAI, Questions, and the Colorado Privacy Act"
  url="mailto:autumn@discoverywritten.com"
%}
...
{% include figure.html file="public-review.png"
  side="right"
  overview="A cropped screenshot fragment of the public reviews on Google. Mine is noted at the bottom of the short list with a single star."
  caption="My public review is currently featured nearby an old one that reports 'The management/office people are constantly changing.'"
%}
...
{% include cite.html
  credit="November 16: Me, after Their Silence"
  headline="(Request ID: FJWVTS9ND6) Unable to verify your identity"
  url="mailto:autumn@discoverywritten.com"
%}
...
{% include cite.html
  credit="November 19: Me again, after Their Silence"
  headline="(Request ID: FJWVTS9ND6) Unable to verify your identity"
  url="mailto:autumn@discoverywritten.com"
%}
...
At the Colorado Sun event which I attended with Chris Crewnshaw of [://fcreport.org](//fcreport.org), I was privileged to sit at a round table that included Tammy L. Terwelp and Dana Coffield, of KUNC and Colorado Sun respectively. I was the table's note-taker and conversation stimulator.
...
{% include cite.html
  credit="December 1: Email with footer signed by 'Service Account'"
  headline="(Request ID: FJWVTS9ND6) Brookfield Properties Request"
  url="mailto:dataprivacy@brookfieldproperties.com"
%}

> Dear Autumn Valenta,

> Thank you for contacting Brookfield Properties regarding the processing of your personal information. You can expect to receive a response within approximately 45 days from the date we initially received your request. We will notify you if we need additional
>  time.

> If you did not make this request, or have additional questions, please contact us DataPrivacy@BrookfieldProperties.com

> Sincerely,

> Brookfield Properties Data Privacy

{% include figure.html file="Service-Account.png"
  overview="A cropped screenshot fragment of the email footer adorning each reply from the Service Account emailer."
  caption="Note the international address where so-called Service Account comes from."
%}
